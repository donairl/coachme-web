...
<section class="page-section bg-primary" id="about">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <iframe width="853" height="480" src="https://www.youtube.com/embed/HPRURtORnis?autoplay=0&modestbranding=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <br>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-12 text-center">
                        ...
                        <hr class="divider light my-4">
                        <p class="text-white-50 mb-4">Coming soon!</p>
                        <a class="btn btn-default" href="#services">Get News Updates</a>
                    </div>
                </div>
            </div>
</section>
